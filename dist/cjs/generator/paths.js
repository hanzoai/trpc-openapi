...
const getOpenApiPathsObject = (appRouter, securitySchemeNames, filter) => {
    ...
    (0, utils_1.forEachOpenApiProcedure)(procedures, ({ path: procedurePath, type, procedure, meta }) => {
        ...
        try {
            ...
            const responseSchema = (0, utils_1.instanceofZodType)(outputParser) ? outputParser : zod_1.z.object({});
            ...
            const responses = (0, schema_1.getResponsesObject)(responseSchema, httpMethod, responseHeaders, protect, (0, schema_1.hasInputs)(inputParser), successDescription, errorResponses);
